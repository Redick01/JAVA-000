package com.renminbiaccount.config;
...
public class RenminbiAccountDataSourceConfiguration {

    @Value("${mysql.account.url}")
    private String url;
    @Value("${mysql.account.username}")
    private String username;
    @Value("${mysql.account.password}")
